...
prompt Created on Monday, 27 May 2024 by Naama
set feedback off
set define off
...
alter table PRODUCT disable constraint SYS_C008240;
prompt Disabling foreign key constraints for INGREDIENTS...
alter table INGREDIENTS disable constraint SYS_C008268;
alter table INGREDIENTS disable constraint SYS_C008269;
prompt Disabling foreign key constraints for ORDERS...
alter table ORDERS disable constraint SYS_C008252;
prompt Disabling foreign key constraints for MEALORDER...
alter table MEALORDER disable constraint SYS_C008262;
alter table MEALORDER disable constraint SYS_C008263;
prompt Disabling foreign key constraints for WORKERORDER...
alter table WORKERORDER disable constraint SYS_C008256;
alter table WORKERORDER disable constraint SYS_C008257;
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('064-9019064', 'Jena-Gary', 'Toronto,62 Barbengo ', 895979028);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('092-2309965', 'Vince-Paxton', 'Horb,45 Ben Street', 599299892);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('083-4099753', 'Garth-Spine', 'Storrington,90 Wes R', 514904529);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('012-5652322', 'Cary-Rhames', 'Granada Hills,9 Marx', 808796447);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('070-2108122', 'Dar-Renfro', 'Ribeirao preto,78 Pi', 278642153);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('078-2007478', 'Eric-Shand', 'Schenectady,19 Vince', 518994648);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('079-2802575', 'Suzy-Albright', 'Suwon-city,516 Matar', 141286470);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('024-4461151', 'Clay-Squier', 'Ebersdorf,22 Brody R', 808495905);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('018-4567629', 'Sal-Church', 'Moreno Valley,77 New', 949372694);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('077-9307812', 'Hex-Chaplin', 'Pecs,69 Clark Street', 236762547);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('056-3186158', 'Maria-Cruz', 'Sorocaba,323 Blige D', 872804100);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('011-5641809', 'Jann-Payton', 'West Monroe,12nd Str', 977554198);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('094-6691297', 'Nils-Connelly', 'Peachtree City,67 Sa', 355027865);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('080-8249575', 'Kristin-Hewett', 'Munich,77 Bloch Driv', 192646604);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('098-9130878', 'Rose-Ontiveros', 'Ashland,71 Rosco Str', 570764208);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('059-1340571', 'Pierce-Gayle', 'Rothenburg,449 Paisl', 554790135);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('044-1678993', 'Glenn-Bush', 'Maryville,93 Daniel ', 909589275);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('082-2638532', 'Delbert-Stormare', 'Swarthmore,12 Lynch ', 777751819);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('056-3928365', 'Ron-Kidman', 'Silver Spring,4 Domi', 442113021);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('011-5478891', 'Yaphet-Union', 'Bristol,80 Bonnie Bl', 252721669);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('092-5251711', 'Larenz-Reed', 'Oslo,26 Vienna Road', 214486980);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('068-5899621', 'Rene-Puckett', 'Archbold,53 Mint', 361558168);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('055-5700759', 'Jena-Phoenix', 'Bremen,11st Street', 970287710);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('079-7901383', 'Yaphet-Hornsby', 'Los Angeles,21st Str', 376521204);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('080-5649752', 'Dwight-Brickell', 'Kobe,82 Brooks Road', 199640888);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('083-6032919', 'Ewan-Moffat', 'Taipei,85 Lennie', 621864883);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('079-7080094', 'Jean-Costner', 'Herzogenrath,21st St', 877964589);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('016-9138553', 'Miranda-Winans', 'Duluth,15 Batavia St', 736458114);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('061-1290987', 'Kathy-Dafoe', 'Kyoto,59 Miami Drive', 746221819);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('036-1750167', 'Heath-Webb', 'Leverkusen,78 Rickle', 983648738);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('015-2118434', 'Carol-Bates', 'Hayward,58 Gellar Ro', 980282242);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('052-9299986', 'Harris-Lerner', 'Zaandam,90 Eldard', 214300616);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('073-7478632', 'Amy-Roundtree', 'Hiroshima,87 Vin Roa', 741314233);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('049-5841158', 'Angela-Davidson', 'Appenzell,878 Atlas ', 654684525);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('047-3155398', 'Heather-Walker', 'Granada Hills,714 Ca', 211084650);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('089-2357371', 'Leelee-Robbins', 'Duluth,86 Green Driv', 554534966);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('098-5798694', 'Garland-Coburn', 'St Leonards,50 Rockw', 394500136);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('076-2830666', 'Sophie-Pressly', 'Walnut Creek,16 Jake', 347549032);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('035-9943334', 'Tcheky-Bosco', 'Storrington,52 Wakel', 970402642);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('092-1929414', 'Nikka-Dysart', 'Grand Rapids,51st St', 811637701);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('088-5134506', 'Carlene-Klugh', 'Rosario,9 Costa Stre', 764421102);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('050-7741104', 'Balthazar-Gaynor', 'Koeln,96 Lynne Road', 466227468);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('072-5100527', 'Temuera-Evanswood', 'Holderbank,22 Jean-C', 378824967);
commit;
prompt 100 records committed...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('078-1613715', 'Kiefer-Silverman', 'Cobham,347 Algermiss', 410227355);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('062-1458189', 'Tilda-Postlethwaite', 'Englewood Cliffs,11s', 225885687);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('046-8006517', 'Jerry-Akins', 'Mogi Guacu,72nd Stre', 342984634);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('049-3863806', 'Hilton-Paul', 'Casselberry,47 Bresl', 772403742);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('055-8638801', 'Don-Mewes', 'Seattle,76 Aimee Dri', 756586900);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('082-9958465', 'Sam-Reid', 'Saitama,634 Jackie B', 202988966);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('076-2296536', 'Debbie-Rowlands', 'Pearland,76 Freiburg', 934973095);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('043-3114830', 'Elle-Sandoval', 'Goiania,27 Palmieri ', 360252279);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('093-3044845', 'Cathy-Romijn-Stamos', 'Salisbury,96 Roma St', 944959614);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('022-6824283', 'Danni-Gill', 'Lake worth,92nd Stre', 353134007);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('076-7911880', 'Judi-DiFranco', 'Sihung-si,932 Knight', 843684860);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('055-3559415', 'Thora-Davis', 'Singapore,143 Cronin', 324999550);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('061-6632126', 'Tobey-Wills', 'Aracruz,38 Kirshner ', 548972868);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('081-4823555', 'Jena-Tolkan', 'Pacific Grove,10 Bas', 277941686);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('027-7953606', 'Sharon-Hurt', 'Samrand,64 Geoffrey ', 896151890);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('098-8520574', 'Clive-Arden', 'Boulogne,100 Elwes S', 886181267);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('024-1500889', 'Lloyd-Cobbs', 'New Hope,221 Channin', 834842795);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('090-8565589', 'Karen-Franks', 'West Launceston,89 F', 150516159);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('050-5792193', 'Richard-Ruiz', 'Meerbusch,83 Jill Ro', 695623822);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('088-6813553', 'Natacha-Blackwell', 'Maarssen,66 Kasey Dr', 397341956);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('036-7485040', 'Bob-Parsons', 'Bautzen,526 Alan Roa', 131927725);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('052-8389162', 'Isaiah-Browne', 'San Antonio,46 Night', 639840454);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('016-6599897', 'Meg-Sossamon', 'Immenstaad,408 Jody ', 738961356);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('069-5717395', 'Goran-Warden', 'Leverkusen,76 Orange', 711190112);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('034-6150500', 'Ozzy-Pigott-Smith', 'Hackensack,33 Fiona ', 472479875);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('043-2653096', 'Rupert-Albright', 'Nancy,37 Summer', 860761954);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('019-1749052', 'Jena-McNarland', 'Laredo,84 Guilfoyle ', 982240416);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('064-2945927', 'Faye-Deschanel', 'München,21st Street', 594823906);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('037-5666150', 'Cameron-Coe', 'Oakland,10 Roma Ave', 783831334);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('095-9291576', 'Lynn-Englund', 'Biel,36 Marshall Str', 304261315);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('084-3256637', 'Terri-Rickles', 'El Dorado Hills,9 Na', 774543862);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('056-6767109', 'Jonny Lee-Moreno', 'Bratislava,496 Odens', 729570733);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('037-3703602', 'Omar-Gary', 'San Francisco,7 Prag', 934959681);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('050-4934460', 'Kathy-Molina', 'Barnegat,50 Curfman ', 124736224);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('077-2175527', 'Cherry-Tsettos', 'Zurich,85 Lawrence B', 789224520);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('089-6201696', 'Whoopi-Houston', 'Istanbul,782 Baransk', 992538213);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('011-2967354', 'Al-Marie', 'Pacific Grove,62 Bir', 173415876);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('046-3602401', 'Helen-Gallant', 'Mogi Guacu,80 Greenv', 862513457);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('090-3140789', 'Ceili-Colman', 'Ashdod,100 Cochran S', 750989130);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('046-3045462', 'Chaka-Fiorentino', 'St-laurent,92nd Stre', 660797697);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('064-4562749', 'Robby-Satriani', 'Paderborn,76 Trieste', 678050026);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('021-3132716', 'Wade-Boothe', 'Charleston,65 Schrei', 880677173);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('058-8672808', 'Andrea-Gary', 'Zaandam,275 McCready', 429821301);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('020-7088989', 'Jon-Mortensen', 'Waco,29 Mulroney Roa', 765863839);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('082-3340977', 'Chloe-Malone', 'Fort McMurray,30 Pri', 446906795);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('045-8975257', 'Jessica-Beck', 'Yucca,92nd Street', 792744882);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('091-4662747', 'Elle-Breslin', 'Solikamsk,3 Martin S', 320984084);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('079-9918900', 'Ronny-Stone', 'Cambridge,817 Ricci ', 324451997);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('045-7603988', 'Terrence-Payne', 'Springfield,91 Lilla', 859555017);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('053-1971680', 'Arturo-Statham', 'Rome,48 Salonga Stre', 779881614);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('092-5085153', 'Pierce-Chaplin', 'Santa Fe,49 Diaz Blv', 726203109);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('072-7047995', 'Quentin-Summer', 'Irkutsk,58 Darius Av', 853517846);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('036-9139126', 'Gran-Flatts', 'Slmea,90 Colin Young', 398613717);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('036-2782453', 'Kasey-Wiedlin', 'Warley,157 Carnes St', 898674199);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('047-4957502', 'LeVar-Hurt', 'Rheinfelden,125 Delt', 651612329);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('056-7615871', 'Jane-Overstreet', 'Kopavogur,61 Gilley ', 567225446);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('090-7466221', 'Kenny-Adler', 'Santa Clarat,977 Agl', 273156212);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('035-4693995', 'Dennis-Del Toro', 'Granada Hills,56 Lin', 197619991);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('078-4880145', 'Mira-Gano', 'Dallas,94 Collin', 929328580);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('034-7389859', 'Michelle-Santana', 'Oshawa,54 Heatherly ', 972945925);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('049-3453126', 'Jonatha-McKellen', 'Berlin-Adlershof,671', 482258360);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('040-6555298', 'Angelina-Cocker', 'Budapest,55 Lewin St', 156416457);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('035-1113805', 'Lila-Rucker', 'Bracknell,74 Parish ', 928020274);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('031-3680647', 'Thin-Durning', 'New hartford,780 Bur', 297189264);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('064-4761425', 'William-Beckinsale', 'Kaohsiung,5 LaBelle ', 317073810);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('091-1976795', 'Nils-McGriff', 'Delafield,76 Terrenc', 127191299);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('011-2106546', 'Edward-Guest', 'Courbevoie,17 Rutger', 201884188);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('028-1987717', 'Kid-McClinton', 'Mclean,238 Morales D', 326506497);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('094-9942498', 'Chalee-Connery', 'Thalwil,51 Yolanda S', 457364031);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('078-6534800', 'Kate-Williamson', 'Limeira,90 Ojeda Blv', 464276016);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('031-3359375', 'Daniel-Shaw', 'Foster City,326 Redg', 224495473);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('041-2535931', 'Maxine-Ali', 'Sao roque,99 Moffat ', 224940419);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('034-5608975', 'Ian-Barry', 'Lexington,76 Holderb', 851890097);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('041-8670226', 'Isaiah-Damon', 'Ankara,74 Jenkins Ro', 388964714);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('053-2353086', 'Terence-Norton', 'Athens,74 Kweller St', 762606075);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('035-8422902', 'Lily-Morrison', 'Market Harborough,58', 307016500);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('074-8043918', 'Sheena-Robinson', 'Lakeville,28 Hilton ', 268150110);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('075-6087423', 'Derrick-Holiday', 'Tucson,572 Wiest', 262224825);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('088-3928523', 'Parker-Gere', 'Borger,12 Armatradin', 205591518);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('095-9665937', 'Etta-Sylvian', 'Espoo,64 Spector Dri', 218429826);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('099-5069499', 'Adam-Lowe', 'Las Vegas,259 Di Sav', 486249177);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('026-7580278', 'Hilary-Anderson', 'Orlando,448 Hong Kon', 455396724);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('027-1283311', 'Victoria-Loggins', 'Portsmouth,60 Damon ', 795381277);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('061-6482468', 'Rhys-Ontiveros', 'Treviso,83rd Street', 487981995);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('087-1919969', 'Christopher-Winslet', 'Mantova,41 Avalon St', 984030504);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('050-7843564', 'Ali-Rush', 'Kevelaer,29 Hanks', 316377523);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('021-8343650', 'Kevn-Foxx', 'Parma,83 Woodard Dri', 689426993);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('047-2796483', 'Grant-Luongo', 'Washington,3 Rush Av', 611173011);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('044-3855447', 'Irene-Porter', 'Tulsa,164 Farrell Ro', 411251955);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('026-9616486', 'Angelina-Fiennes', 'Dallas,48 Owen Road', 126094230);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('040-4668735', 'Frankie-Edmunds', 'Mechanicsburg,67 Alt', 860797149);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('015-5196196', 'Pablo-Theron', 'Alexandria,39 Burns ', 235381758);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('056-4779228', 'Johnnie-Field', 'Juno Beach,829 San F', 920832142);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('023-2112060', 'Hugo-Michaels', 'Pitstone,607 Lange', 871596785);
commit;
prompt 300 records committed...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('045-3638185', 'Aaron-Nicholson', 'Yamaguchi,91 Tierney', 656234359);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('071-3891313', 'Tcheky-Sweet', 'Alcobendas,1 Mel Str', 529660004);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('015-6359713', 'Eliza-Hatchet', 'San Jose,52 Olyphant', 594688241);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('053-8214561', 'Ice-Hayek', 'Sugar Hill,92 Theron', 351022726);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('051-6672445', 'Casey-Ali', 'Hjallerup,80 Dutton ', 706065580);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('099-6027514', 'Seann-Craddock', 'Cleveland,60 Diggs S', 276171371);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('021-1587422', 'Merillee-Williams', 'Pandrup,70 Gordon Dr', 813539248);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('074-5609736', 'Jeremy-Spector', 'Wavre,66 Maryville D', 440265918);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('024-1278402', 'Edgar-Peet', 'Manchester,50 Terren', 815123821);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('023-3608257', 'Lari-Kramer', 'Netanya,50 Valentin ', 474496095);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('018-2667880', 'Jena-Dench', 'Royston,80 Lummen Av', 328879351);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('021-1998744', 'Steve-Leary', 'Hermitage,98 Colombe', 966959461);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('064-2119621', 'Phoebe-Weaver', 'Livermore,252 Holbro', 575316296);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('025-8340705', 'Gord-Craven', 'Sendai,11st Street', 740888493);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('015-1644758', 'Anne-Depp', 'Houston,90 Elizabeth', 162188042);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('078-5411539', 'Shirley-Aniston', 'Verwood,310 Roy Driv', 516928403);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('090-3254713', 'Heather-Brown', 'Mainz-kastel,47 Byrn', 842738339);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('066-6068174', 'Frank-Robbins', 'Stafford,12nd Street', 263919983);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('061-7385493', 'Dermot-Wilkinson', 'Amsterdam,491 Machin', 221244365);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('032-2283927', 'Amy-Dempsey', 'Nicosia,22 Twilley R', 881683474);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('043-6139576', 'Bernard-Melvin', 'Waterloo,93 Webb Str', 933507931);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('084-3098771', 'Balthazar-Hauer', 'Archbold,74 Sao caet', 967817873);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('021-7003399', 'Shawn-Shaw', 'Kyunnam,5 Philadelph', 839962152);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('016-9037187', 'Lizzy-Emmerich', 'Oak park,66 Jane Ave', 242192420);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('078-3399830', 'Steve-Myers', 'Knutsford,55 Grant B', 767292828);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('053-2190204', 'Whoopi-Cook', 'Fremont,14 Batavia D', 469009800);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('077-3488838', 'Gran-Willard', 'Portland,29 Garner R', 421138666);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('089-3223808', 'Suzy-Astin', 'Bollensen,97 Clive D', 452224080);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('059-9522968', 'Millie-Mandrell', 'Mississauga,63rd Str', 778481350);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('045-6400535', 'Benicio-Downey', 'Wilmington,78 Neve S', 479702379);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('072-4993628', 'Ceili-Teng', 'Rtp,86 Regina Road', 888273898);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('078-1184416', 'Carlos-Gaynor', 'Glen Cove,701 Lawren', 311909697);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('079-5731972', 'Randall-Dillane', 'Orleans,632 Burmeste', 491523991);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('069-6143635', 'Glen-Snipes', 'Bellevue,74 Bonham A', 429602143);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('087-3684145', 'Jeffery-Weller', 'Redwood City,200 Byr', 362394357);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('037-2250778', 'Rueben-Woodward', 'Irati,10 Neustadt Ro', 175161719);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('096-1134292', 'Christopher-Brandt', 'Hiroshima,24 Beatty ', 322102919);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('069-9481674', 'Pete-Nunn', 'Herne,78 Coolidge St', 950932629);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('077-4706627', 'Rhys-Carmen', 'Gävle,42nd Street', 473527829);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('091-6885415', 'Emilio-Soda', 'Wilmington,71 Street', 419766136);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('034-9713989', 'Chrissie-Harary', 'Green bay,23 Matsuya', 409349671);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
values ('057-8172686', 'Rutger-Firth', 'Springville,83 Night', 936576358);
insert into CUSTOMERS (custphonenumber, custname, custaddress, custid)
...
values (59182, 188, 'Received', to_date('04-01-2024', 'dd-mm-yyyy'), 199640888);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (65592, 90, 'Received', to_date('20-04-2024', 'dd-mm-yyyy'), 296255366);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (61398, 135, 'in-preparation', to_date('11-01-2024', 'dd-mm-yyyy'), 216541625);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (41599, 299, 'Delivered', to_date('28-02-2024', 'dd-mm-yyyy'), 296255366);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (80222, 259, 'Received', to_date('04-02-2024', 'dd-mm-yyyy'), 390110769);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (84259, 145, 'in-preparation', to_date('06-04-2024', 'dd-mm-yyyy'), 789562188);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (56419, 269, 'in-preparation', to_date('27-01-2024', 'dd-mm-yyyy'), 738961356);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (50051, 1, 'Received', to_date('06-03-2024', 'dd-mm-yyyy'), 974693239);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (13604, 75, 'in-preparation', to_date('13-03-2024', 'dd-mm-yyyy'), 464221141);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (52830, 135, 'Received', to_date('10-02-2024', 'dd-mm-yyyy'), 739894646);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (90296, 149, 'in-preparation', to_date('17-01-2024', 'dd-mm-yyyy'), 966414435);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (81313, 27, 'Delivered', to_date('26-04-2024', 'dd-mm-yyyy'), 586258847);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (12869, 179, 'Sent', to_date('12-02-2024', 'dd-mm-yyyy'), 850094083);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (53802, 10, 'Ready', to_date('06-02-2024', 'dd-mm-yyyy'), 620322646);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (83038, 265, 'in-preparation', to_date('03-05-2024', 'dd-mm-yyyy'), 689426993);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (77648, 159, 'in-preparation', to_date('19-04-2024', 'dd-mm-yyyy'), 989065808);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (43344, 59, 'Delivered', to_date('27-02-2024', 'dd-mm-yyyy'), 275420456);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (55995, 375, 'Sent', to_date('01-05-2024', 'dd-mm-yyyy'), 709566924);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (91609, 9, 'in-preparation', to_date('02-03-2024', 'dd-mm-yyyy'), 157141811);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (70838, 39, 'Delivered', to_date('18-01-2024', 'dd-mm-yyyy'), 836439971);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (62222, 239, 'Ready', to_date('25-02-2024', 'dd-mm-yyyy'), 390110769);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (26243, 10, 'Delivered', to_date('22-01-2024', 'dd-mm-yyyy'), 850094083);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (58566, 99, 'Sent', to_date('26-01-2024', 'dd-mm-yyyy'), 894904744);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (91902, 69, 'in-preparation', to_date('16-01-2024', 'dd-mm-yyyy'), 618573694);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (20340, 35, 'in-preparation', to_date('28-02-2024', 'dd-mm-yyyy'), 224495473);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (55900, 10, 'Sent', to_date('06-05-2024', 'dd-mm-yyyy'), 771701713);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (21626, 115, 'Ready', to_date('28-01-2024', 'dd-mm-yyyy'), 654712365);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (17887, 159, 'Ready', to_date('09-02-2024', 'dd-mm-yyyy'), 445757640);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (43689, 9, 'Ready', to_date('21-01-2024', 'dd-mm-yyyy'), 427332445);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (32407, 209, 'Ready', to_date('09-05-2024', 'dd-mm-yyyy'), 166381326);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (95080, 1, 'Received', to_date('12-05-2024', 'dd-mm-yyyy'), 589291628);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (59102, 119, 'Received', to_date('06-05-2024', 'dd-mm-yyyy'), 942708002);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (51690, 5, 'Sent', to_date('08-05-2024', 'dd-mm-yyyy'), 903486694);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (36670, 135, 'in-preparation', to_date('25-04-2024', 'dd-mm-yyyy'), 282036733);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (88772, 344, 'Ready', to_date('11-05-2024', 'dd-mm-yyyy'), 458886237);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (76341, 385, 'Sent', to_date('18-03-2024', 'dd-mm-yyyy'), 649748137);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (59034, 25, 'in-preparation', to_date('05-01-2024', 'dd-mm-yyyy'), 974693239);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (29434, 45, 'Ready', to_date('08-01-2024', 'dd-mm-yyyy'), 660797697);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (85504, 39, 'Sent', to_date('02-03-2024', 'dd-mm-yyyy'), 977753609);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (94380, 45, 'Sent', to_date('27-01-2024', 'dd-mm-yyyy'), 560391764);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (57470, 44, 'Received', to_date('01-01-2024', 'dd-mm-yyyy'), 805854680);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (30440, 35, 'Delivered', to_date('23-02-2024', 'dd-mm-yyyy'), 328879351);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (25469, 179, 'in-preparation', to_date('26-03-2024', 'dd-mm-yyyy'), 935291735);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (99235, 38, 'Received', to_date('17-04-2024', 'dd-mm-yyyy'), 129121934);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (12999, 125, 'in-preparation', to_date('03-02-2024', 'dd-mm-yyyy'), 388964714);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (73356, 195, 'Sent', to_date('24-02-2024', 'dd-mm-yyyy'), 833739957);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (19134, 375, 'Ready', to_date('01-01-2024', 'dd-mm-yyyy'), 935291735);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (77882, 139, 'Delivered', to_date('29-04-2024', 'dd-mm-yyyy'), 295158882);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (60888, 79, 'in-preparation', to_date('05-01-2024', 'dd-mm-yyyy'), 746060762);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (89590, 43, 'Delivered', to_date('22-03-2024', 'dd-mm-yyyy'), 237093998);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (34274, 35, 'Received', to_date('18-04-2024', 'dd-mm-yyyy'), 454954065);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (75923, 265, 'Sent', to_date('28-03-2024', 'dd-mm-yyyy'), 349840942);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (11979, 139, 'Ready', to_date('16-04-2024', 'dd-mm-yyyy'), 704448570);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (82193, 1, 'Ready', to_date('05-03-2024', 'dd-mm-yyyy'), 190711252);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (27027, 149, 'in-preparation', to_date('13-04-2024', 'dd-mm-yyyy'), 777678448);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (22459, 28, 'Ready', to_date('11-02-2024', 'dd-mm-yyyy'), 144207533);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (68154, 89, 'Sent', to_date('07-01-2024', 'dd-mm-yyyy'), 115550235);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (49445, 18, 'in-preparation', to_date('24-03-2024', 'dd-mm-yyyy'), 805401712);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (66170, 519, 'Sent', to_date('18-03-2024', 'dd-mm-yyyy'), 777766742);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (21832, 125, 'Ready', to_date('15-01-2024', 'dd-mm-yyyy'), 192646604);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (20942, 579, 'in-preparation', to_date('05-04-2024', 'dd-mm-yyyy'), 983955606);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (90871, 8, 'Received', to_date('14-05-2024', 'dd-mm-yyyy'), 785335488);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (70342, 35, 'Ready', to_date('06-03-2024', 'dd-mm-yyyy'), 514205703);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (50309, 179, 'Sent', to_date('02-04-2024', 'dd-mm-yyyy'), 463878923);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (73066, 10, 'Ready', to_date('21-01-2024', 'dd-mm-yyyy'), 530559367);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (27478, 194, 'in-preparation', to_date('14-01-2024', 'dd-mm-yyyy'), 897322670);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (35602, 28, 'in-preparation', to_date('07-01-2024', 'dd-mm-yyyy'), 361558168);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (25069, 94, 'Received', to_date('01-04-2024', 'dd-mm-yyyy'), 197619991);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (57715, 219, 'in-preparation', to_date('16-04-2024', 'dd-mm-yyyy'), 202423128);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (33488, 24, 'Ready', to_date('21-03-2024', 'dd-mm-yyyy'), 563480832);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (33364, 10, 'Ready', to_date('01-05-2024', 'dd-mm-yyyy'), 242192420);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (12632, 199, 'Delivered', to_date('18-03-2024', 'dd-mm-yyyy'), 735716196);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (64409, 24, 'in-preparation', to_date('11-01-2024', 'dd-mm-yyyy'), 849303235);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (28977, 7, 'Delivered', to_date('17-02-2024', 'dd-mm-yyyy'), 907287038);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (99743, 185, 'Received', to_date('26-03-2024', 'dd-mm-yyyy'), 479411599);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (25737, 20, 'Delivered', to_date('18-03-2024', 'dd-mm-yyyy'), 815123821);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (77517, 69, 'Sent', to_date('04-05-2024', 'dd-mm-yyyy'), 603150426);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (67538, 618, 'in-preparation', to_date('08-04-2024', 'dd-mm-yyyy'), 987656414);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (49599, 49, 'Ready', to_date('17-03-2024', 'dd-mm-yyyy'), 409771057);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (32626, 250, 'Ready', to_date('02-04-2024', 'dd-mm-yyyy'), 423632765);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (81401, 39, 'Delivered', to_date('13-04-2024', 'dd-mm-yyyy'), 529782749);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (55270, 229, 'Sent', to_date('01-03-2024', 'dd-mm-yyyy'), 575427604);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (77945, 25, 'Received', to_date('29-03-2024', 'dd-mm-yyyy'), 761433673);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (24870, 169, 'Ready', to_date('08-05-2024', 'dd-mm-yyyy'), 946312472);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (94029, 149, 'Sent', to_date('27-03-2024', 'dd-mm-yyyy'), 974693239);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (65447, 9, 'Ready', to_date('16-04-2024', 'dd-mm-yyyy'), 177644588);
commit;
prompt 100 records committed...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (15420, 99, 'Sent', to_date('18-01-2024', 'dd-mm-yyyy'), 322102919);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (68596, 35, 'Ready', to_date('18-01-2024', 'dd-mm-yyyy'), 573755457);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (27300, 19, 'Received', to_date('15-03-2024', 'dd-mm-yyyy'), 360260555);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (70313, 56, 'Ready', to_date('02-01-2024', 'dd-mm-yyyy'), 427332445);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (48816, 35, 'in-preparation', to_date('30-01-2024', 'dd-mm-yyyy'), 689426993);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (58886, 58, 'Ready', to_date('12-01-2024', 'dd-mm-yyyy'), 654712365);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (73892, 70, 'Sent', to_date('06-03-2024', 'dd-mm-yyyy'), 733139526);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (34690, 109, 'in-preparation', to_date('13-04-2024', 'dd-mm-yyyy'), 927524225);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (54976, 209, 'Received', to_date('30-01-2024', 'dd-mm-yyyy'), 688095708);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (37145, 95, 'Ready', to_date('23-02-2024', 'dd-mm-yyyy'), 853517846);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (58849, 175, 'in-preparation', to_date('19-04-2024', 'dd-mm-yyyy'), 423632765);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (59718, 69, 'Delivered', to_date('02-05-2024', 'dd-mm-yyyy'), 783806626);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (68695, 255, 'Received', to_date('02-03-2024', 'dd-mm-yyyy'), 896757685);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (49636, 8, 'Ready', to_date('07-05-2024', 'dd-mm-yyyy'), 296255366);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (42600, 265, 'Delivered', to_date('15-04-2024', 'dd-mm-yyyy'), 649748137);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (65660, 179, 'Sent', to_date('14-01-2024', 'dd-mm-yyyy'), 282036733);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (26631, 39, 'Ready', to_date('01-01-2024', 'dd-mm-yyyy'), 351022726);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (27738, 99, 'in-preparation', to_date('06-03-2024', 'dd-mm-yyyy'), 205272172);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (93938, 239, 'in-preparation', to_date('20-03-2024', 'dd-mm-yyyy'), 504536643);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (13340, 399, 'Received', to_date('05-04-2024', 'dd-mm-yyyy'), 476782813);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (45695, 69, 'Sent', to_date('16-04-2024', 'dd-mm-yyyy'), 216541625);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (97641, 229, 'Received', to_date('21-05-2024', 'dd-mm-yyyy'), 487981995);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (37194, 875, 'Received', to_date('21-03-2024', 'dd-mm-yyyy'), 218763605);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (59889, 121, 'Delivered', to_date('29-01-2024', 'dd-mm-yyyy'), 909762395);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (99773, 85, 'in-preparation', to_date('11-04-2024', 'dd-mm-yyyy'), 899381603);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (24848, 16, 'Received', to_date('16-04-2024', 'dd-mm-yyyy'), 681572378);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (99848, 145, 'Received', to_date('20-04-2024', 'dd-mm-yyyy'), 138000652);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (81934, 48, 'Sent', to_date('18-03-2024', 'dd-mm-yyyy'), 895204813);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (37868, 45, 'Received', to_date('25-01-2024', 'dd-mm-yyyy'), 438477170);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (42104, 255, 'Received', to_date('11-02-2024', 'dd-mm-yyyy'), 738961356);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (36951, 109, 'Delivered', to_date('25-02-2024', 'dd-mm-yyyy'), 275420456);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (70413, 229, 'in-preparation', to_date('22-04-2024', 'dd-mm-yyyy'), 944370934);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (20030, 375, 'Sent', to_date('15-05-2024', 'dd-mm-yyyy'), 826107453);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (87126, 121, 'in-preparation', to_date('11-01-2024', 'dd-mm-yyyy'), 366643056);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (19888, 20, 'Ready', to_date('10-03-2024', 'dd-mm-yyyy'), 255733886);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (78934, 89, 'in-preparation', to_date('06-05-2024', 'dd-mm-yyyy'), 928549846);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (47475, 99, 'Delivered', to_date('23-04-2024', 'dd-mm-yyyy'), 544629310);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (98756, 159, 'Ready', to_date('05-03-2024', 'dd-mm-yyyy'), 977753609);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (41047, 179, 'Received', to_date('02-02-2024', 'dd-mm-yyyy'), 605867286);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (42371, 68, 'Ready', to_date('15-05-2024', 'dd-mm-yyyy'), 352004805);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (50999, 45, 'Ready', to_date('25-02-2024', 'dd-mm-yyyy'), 652286041);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (60140, 75, 'Sent', to_date('22-03-2024', 'dd-mm-yyyy'), 903486694);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (77761, 22, 'Received', to_date('29-02-2024', 'dd-mm-yyyy'), 656234359);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (46483, 20, 'Ready', to_date('14-05-2024', 'dd-mm-yyyy'), 252721669);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (61773, 76, 'Sent', to_date('07-05-2024', 'dd-mm-yyyy'), 533475097);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (66321, 14, 'Delivered', to_date('09-02-2024', 'dd-mm-yyyy'), 163717059);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (61805, 89, 'in-preparation', to_date('24-04-2024', 'dd-mm-yyyy'), 395931910);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (76937, 365, 'in-preparation', to_date('14-01-2024', 'dd-mm-yyyy'), 960671680);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (60239, 49, 'Sent', to_date('02-02-2024', 'dd-mm-yyyy'), 783806626);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (64517, 439, 'Sent', to_date('20-03-2024', 'dd-mm-yyyy'), 915869687);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (84168, 94, 'Ready', to_date('20-01-2024', 'dd-mm-yyyy'), 911729605);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (19516, 138, 'Received', to_date('13-01-2024', 'dd-mm-yyyy'), 847683496);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (84806, 69, 'Received', to_date('20-03-2024', 'dd-mm-yyyy'), 862513457);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (69001, 198, 'in-preparation', to_date('10-02-2024', 'dd-mm-yyyy'), 202988966);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (80621, 8, 'Received', to_date('17-05-2024', 'dd-mm-yyyy'), 907597444);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (86256, 109, 'Sent', to_date('12-03-2024', 'dd-mm-yyyy'), 496245735);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (95732, 139, 'Ready', to_date('10-02-2024', 'dd-mm-yyyy'), 484733518);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (82772, 8, 'Delivered', to_date('22-03-2024', 'dd-mm-yyyy'), 171880121);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (86660, 90, 'Received', to_date('28-01-2024', 'dd-mm-yyyy'), 618573694);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (60728, 155, 'Received', to_date('06-01-2024', 'dd-mm-yyyy'), 362427181);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (19701, 106, 'Sent', to_date('17-04-2024', 'dd-mm-yyyy'), 567225446);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (15279, 265, 'Received', to_date('04-01-2024', 'dd-mm-yyyy'), 190012393);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (99134, 99, 'Ready', to_date('19-01-2024', 'dd-mm-yyyy'), 756920718);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (97579, 10, 'Ready', to_date('25-03-2024', 'dd-mm-yyyy'), 977753609);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (36485, 135, 'Delivered', to_date('21-05-2024', 'dd-mm-yyyy'), 750919835);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (75930, 209, 'in-preparation', to_date('13-02-2024', 'dd-mm-yyyy'), 993714527);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (87608, 139, 'Delivered', to_date('16-03-2024', 'dd-mm-yyyy'), 328879351);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (36044, 99, 'Ready', to_date('01-02-2024', 'dd-mm-yyyy'), 273626310);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (61886, 109, 'Ready', to_date('19-03-2024', 'dd-mm-yyyy'), 500276225);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (80875, 109, 'Delivered', to_date('01-02-2024', 'dd-mm-yyyy'), 849466338);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (98527, 38, 'Ready', to_date('08-03-2024', 'dd-mm-yyyy'), 620162965);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (76051, 519, 'Sent', to_date('08-04-2024', 'dd-mm-yyyy'), 436759233);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (69995, 28, 'Delivered', to_date('06-03-2024', 'dd-mm-yyyy'), 826107453);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (43910, 3, 'in-preparation', to_date('03-05-2024', 'dd-mm-yyyy'), 193177293);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (61893, 92, 'Ready', to_date('01-05-2024', 'dd-mm-yyyy'), 738200510);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (87739, 89, 'in-preparation', to_date('06-05-2024', 'dd-mm-yyyy'), 446436968);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (87961, 35, 'Ready', to_date('01-05-2024', 'dd-mm-yyyy'), 371061470);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (91903, 209, 'Ready', to_date('09-01-2024', 'dd-mm-yyyy'), 575427604);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (42080, 385, 'in-preparation', to_date('18-02-2024', 'dd-mm-yyyy'), 862513457);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (55213, 10, 'Ready', to_date('26-02-2024', 'dd-mm-yyyy'), 224495473);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (19231, 59, 'Ready', to_date('09-02-2024', 'dd-mm-yyyy'), 673202124);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (26630, 45, 'Sent', to_date('15-02-2024', 'dd-mm-yyyy'), 427332445);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (90988, 5, 'in-preparation', to_date('04-03-2024', 'dd-mm-yyyy'), 975723107);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (76133, 145, 'Sent', to_date('01-02-2024', 'dd-mm-yyyy'), 427332445);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (47456, 135, 'Sent', to_date('26-03-2024', 'dd-mm-yyyy'), 200082966);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (48748, 149, 'Sent', to_date('11-05-2024', 'dd-mm-yyyy'), 179794254);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (78919, 18, 'Received', to_date('04-03-2024', 'dd-mm-yyyy'), 563480832);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (59943, 65, 'Sent', to_date('19-02-2024', 'dd-mm-yyyy'), 805854680);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (49835, 139, 'Delivered', to_date('01-04-2024', 'dd-mm-yyyy'), 242192420);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (63144, 219, 'Sent', to_date('02-01-2024', 'dd-mm-yyyy'), 772545227);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (28836, 205, 'in-preparation', to_date('20-04-2024', 'dd-mm-yyyy'), 507754009);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (18980, 30, 'Received', to_date('29-01-2024', 'dd-mm-yyyy'), 790353923);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (31887, 38, 'Ready', to_date('25-04-2024', 'dd-mm-yyyy'), 747630593);
commit;
prompt 200 records committed...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (39657, 115, 'in-preparation', to_date('19-05-2024', 'dd-mm-yyyy'), 179794254);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (81331, 519, 'in-preparation', to_date('26-03-2024', 'dd-mm-yyyy'), 218429826);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (19492, 18, 'Ready', to_date('06-04-2024', 'dd-mm-yyyy'), 250944666);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (86739, 8, 'Received', to_date('10-01-2024', 'dd-mm-yyyy'), 576090664);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (32848, 189, 'Delivered', to_date('10-03-2024', 'dd-mm-yyyy'), 573755457);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (75486, 159, 'Ready', to_date('13-02-2024', 'dd-mm-yyyy'), 756920718);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (55778, 23, 'Ready', to_date('29-01-2024', 'dd-mm-yyyy'), 318322784);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (80531, 35, 'Delivered', to_date('23-05-2024', 'dd-mm-yyyy'), 420529630);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (86569, 75, 'Ready', to_date('24-01-2024', 'dd-mm-yyyy'), 721140035);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (46819, 145, 'in-preparation', to_date('16-03-2024', 'dd-mm-yyyy'), 216541625);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (86234, 99, 'Sent', to_date('22-03-2024', 'dd-mm-yyyy'), 736264193);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (95905, 85, 'in-preparation', to_date('17-03-2024', 'dd-mm-yyyy'), 679380064);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (49739, 9, 'Sent', to_date('16-05-2024', 'dd-mm-yyyy'), 838802596);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (18733, 235, 'Sent', to_date('30-03-2024', 'dd-mm-yyyy'), 750919835);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (46561, 58, 'Received', to_date('05-03-2024', 'dd-mm-yyyy'), 336195988);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (21059, 299, 'Ready', to_date('27-03-2024', 'dd-mm-yyyy'), 867830048);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (63034, 119, 'Delivered', to_date('23-05-2024', 'dd-mm-yyyy'), 833739957);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (63840, 35, 'in-preparation', to_date('26-04-2024', 'dd-mm-yyyy'), 750119869);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (33204, 8, 'Received', to_date('13-03-2024', 'dd-mm-yyyy'), 640331895);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (71880, 179, 'Ready', to_date('21-03-2024', 'dd-mm-yyyy'), 688095708);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (98441, 5, 'Received', to_date('06-05-2024', 'dd-mm-yyyy'), 251066882);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (33769, 179, 'in-preparation', to_date('19-05-2024', 'dd-mm-yyyy'), 654684525);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (72289, 389, 'Ready', to_date('11-03-2024', 'dd-mm-yyyy'), 900468358);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (56866, 159, 'Received', to_date('03-05-2024', 'dd-mm-yyyy'), 903277991);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (66958, 239, 'Ready', to_date('17-03-2024', 'dd-mm-yyyy'), 349840942);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (67193, 659, 'Delivered', to_date('06-05-2024', 'dd-mm-yyyy'), 815123821);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (67124, 8, 'in-preparation', to_date('12-03-2024', 'dd-mm-yyyy'), 896151890);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (16791, 595, 'Ready', to_date('29-04-2024', 'dd-mm-yyyy'), 341627864);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (76381, 145, 'in-preparation', to_date('19-02-2024', 'dd-mm-yyyy'), 497469605);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (74675, 289, 'Received', to_date('27-03-2024', 'dd-mm-yyyy'), 203881975);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (95091, 40, 'Delivered', to_date('12-03-2024', 'dd-mm-yyyy'), 894904744);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (93280, 149, 'Received', to_date('03-02-2024', 'dd-mm-yyyy'), 798816085);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (87787, 9, 'in-preparation', to_date('30-03-2024', 'dd-mm-yyyy'), 581815622);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (65615, 159, 'in-preparation', to_date('09-01-2024', 'dd-mm-yyyy'), 644923088);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (91425, 215, 'Delivered', to_date('17-04-2024', 'dd-mm-yyyy'), 272724345);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (80447, 20, 'Received', to_date('12-01-2024', 'dd-mm-yyyy'), 935291735);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (19322, 23, 'Ready', to_date('18-01-2024', 'dd-mm-yyyy'), 362427181);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (93691, 169, 'Delivered', to_date('21-01-2024', 'dd-mm-yyyy'), 388964714);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (24062, 289, 'Ready', to_date('13-04-2024', 'dd-mm-yyyy'), 399318419);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (24895, 95, 'Sent', to_date('30-03-2024', 'dd-mm-yyyy'), 501237230);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (34808, 7, 'Sent', to_date('14-03-2024', 'dd-mm-yyyy'), 640019960);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (65762, 109, 'Received', to_date('07-04-2024', 'dd-mm-yyyy'), 153843514);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (37671, 125, 'Ready', to_date('19-03-2024', 'dd-mm-yyyy'), 216541625);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (56847, 106, 'Ready', to_date('06-04-2024', 'dd-mm-yyyy'), 929328580);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (92098, 269, 'in-preparation', to_date('01-04-2024', 'dd-mm-yyyy'), 898674199);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (47834, 198, 'Sent', to_date('25-02-2024', 'dd-mm-yyyy'), 458886237);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (71353, 8, 'Delivered', to_date('30-04-2024', 'dd-mm-yyyy'), 529665183);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (42565, 65, 'Ready', to_date('15-04-2024', 'dd-mm-yyyy'), 203093493);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (72084, 155, 'in-preparation', to_date('22-04-2024', 'dd-mm-yyyy'), 960671680);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (83491, 595, 'in-preparation', to_date('06-04-2024', 'dd-mm-yyyy'), 484622079);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (41351, 165, 'in-preparation', to_date('19-03-2024', 'dd-mm-yyyy'), 750919835);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (29727, 39, 'Ready', to_date('02-05-2024', 'dd-mm-yyyy'), 990813819);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (70495, 78, 'Ready', to_date('22-03-2024', 'dd-mm-yyyy'), 167375351);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (61649, 398, 'Ready', to_date('30-03-2024', 'dd-mm-yyyy'), 588037827);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (28857, 54, 'in-preparation', to_date('11-03-2024', 'dd-mm-yyyy'), 761433673);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (96704, 8, 'Sent', to_date('21-04-2024', 'dd-mm-yyyy'), 544629310);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (58572, 239, 'Delivered', to_date('30-04-2024', 'dd-mm-yyyy'), 903486694);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (76355, 2, 'Ready', to_date('09-01-2024', 'dd-mm-yyyy'), 336195988);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (28892, 1, 'Received', to_date('07-01-2024', 'dd-mm-yyyy'), 701436220);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (74134, 169, 'Ready', to_date('08-02-2024', 'dd-mm-yyyy'), 789224520);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (74919, 6, 'Received', to_date('21-04-2024', 'dd-mm-yyyy'), 237093998);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (44590, 159, 'Sent', to_date('04-02-2024', 'dd-mm-yyyy'), 323148897);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (78815, 29, 'Sent', to_date('22-04-2024', 'dd-mm-yyyy'), 202938205);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (65289, 289, 'Received', to_date('20-05-2024', 'dd-mm-yyyy'), 318322784);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (71930, 179, 'in-preparation', to_date('27-02-2024', 'dd-mm-yyyy'), 563480832);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (65915, 135, 'in-preparation', to_date('13-01-2024', 'dd-mm-yyyy'), 202988966);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (32090, 48, 'Delivered', to_date('30-03-2024', 'dd-mm-yyyy'), 871869784);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (91999, 299, 'Ready', to_date('31-03-2024', 'dd-mm-yyyy'), 304261315);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (81587, 29, 'Delivered', to_date('17-05-2024', 'dd-mm-yyyy'), 463371951);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (54954, 159, 'Received', to_date('03-05-2024', 'dd-mm-yyyy'), 764421102);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (24835, 229, 'Sent', to_date('12-02-2024', 'dd-mm-yyyy'), 974693239);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (62208, 119, 'in-preparation', to_date('23-02-2024', 'dd-mm-yyyy'), 604322566);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (31211, 327, 'in-preparation', to_date('16-03-2024', 'dd-mm-yyyy'), 395931910);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (48643, 75, 'in-preparation', to_date('28-01-2024', 'dd-mm-yyyy'), 530559367);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (83159, 72, 'Ready', to_date('12-01-2024', 'dd-mm-yyyy'), 688095708);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (42625, 39, 'in-preparation', to_date('05-02-2024', 'dd-mm-yyyy'), 529665183);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (24858, 45, 'Delivered', to_date('18-05-2024', 'dd-mm-yyyy'), 895204813);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (20029, 45, 'Ready', to_date('24-04-2024', 'dd-mm-yyyy'), 833739957);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (62671, 399, 'Delivered', to_date('05-04-2024', 'dd-mm-yyyy'), 895204813);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (64860, 136, 'Sent', to_date('08-02-2024', 'dd-mm-yyyy'), 221770313);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (37623, 10, 'Received', to_date('11-01-2024', 'dd-mm-yyyy'), 867830048);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (65475, 119, 'Received', to_date('27-02-2024', 'dd-mm-yyyy'), 272031711);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (17045, 119, 'Delivered', to_date('02-02-2024', 'dd-mm-yyyy'), 353482730);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (52464, 125, 'Received', to_date('28-01-2024', 'dd-mm-yyyy'), 597771718);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (59111, 11, 'Received', to_date('29-04-2024', 'dd-mm-yyyy'), 847683496);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (92215, 389, 'Received', to_date('19-01-2024', 'dd-mm-yyyy'), 903277991);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (62397, 259, 'Delivered', to_date('30-04-2024', 'dd-mm-yyyy'), 192646604);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (98632, 40, 'Ready', to_date('31-01-2024', 'dd-mm-yyyy'), 164502431);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (65668, 275, 'Received', to_date('02-03-2024', 'dd-mm-yyyy'), 464221141);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (73079, 95, 'Ready', to_date('02-02-2024', 'dd-mm-yyyy'), 355899957);
commit;
prompt 300 records committed...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (33286, 375, 'Ready', to_date('21-02-2024', 'dd-mm-yyyy'), 682288204);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (49082, 9, 'in-preparation', to_date('28-01-2024', 'dd-mm-yyyy'), 922094598);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (70069, 55, 'Delivered', to_date('30-03-2024', 'dd-mm-yyyy'), 701436220);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (75660, 119, 'Ready', to_date('25-02-2024', 'dd-mm-yyyy'), 911729605);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (94928, 152, 'Received', to_date('16-01-2024', 'dd-mm-yyyy'), 750919835);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (82646, 56, 'Received', to_date('17-05-2024', 'dd-mm-yyyy'), 221244365);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (92979, 125, 'Ready', to_date('11-03-2024', 'dd-mm-yyyy'), 897322670);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (38435, 125, 'Received', to_date('10-02-2024', 'dd-mm-yyyy'), 900468358);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (33271, 132, 'Received', to_date('22-05-2024', 'dd-mm-yyyy'), 795843818);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (18689, 36, 'Sent', to_date('09-01-2024', 'dd-mm-yyyy'), 764421102);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (33802, 169, 'Received', to_date('21-05-2024', 'dd-mm-yyyy'), 705165132);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (81348, 75, 'Sent', to_date('29-03-2024', 'dd-mm-yyyy'), 655844485);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (27108, 255, 'Sent', to_date('23-04-2024', 'dd-mm-yyyy'), 563480832);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (16625, 229, 'Sent', to_date('12-03-2024', 'dd-mm-yyyy'), 709566924);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (78421, 198, 'in-preparation', to_date('09-02-2024', 'dd-mm-yyyy'), 251002805);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (27249, 299, 'Delivered', to_date('04-03-2024', 'dd-mm-yyyy'), 533475097);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (39709, 16, 'in-preparation', to_date('23-02-2024', 'dd-mm-yyyy'), 197619991);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (21699, 109, 'Received', to_date('14-05-2024', 'dd-mm-yyyy'), 138000652);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (81336, 36, 'Received', to_date('14-01-2024', 'dd-mm-yyyy'), 909762395);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (44544, 44, 'Received', to_date('14-04-2024', 'dd-mm-yyyy'), 416941052);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (26352, 118, 'Received', to_date('13-03-2024', 'dd-mm-yyyy'), 446436968);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (71835, 299, 'Received', to_date('08-01-2024', 'dd-mm-yyyy'), 181724644);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (38809, 95, 'Delivered', to_date('12-04-2024', 'dd-mm-yyyy'), 750919835);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (95330, 7, 'Received', to_date('26-01-2024', 'dd-mm-yyyy'), 257662071);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (47782, 179, 'Sent', to_date('26-04-2024', 'dd-mm-yyyy'), 202423128);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (36681, 20, 'Delivered', to_date('24-03-2024', 'dd-mm-yyyy'), 681572378);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (89117, 45, 'in-preparation', to_date('25-03-2024', 'dd-mm-yyyy'), 129466992);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (37794, 43, 'Sent', to_date('07-01-2024', 'dd-mm-yyyy'), 756920718);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (27419, 75, 'Delivered', to_date('08-05-2024', 'dd-mm-yyyy'), 590210023);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (22328, 289, 'Ready', to_date('19-04-2024', 'dd-mm-yyyy'), 963819761);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (94695, 198, 'Delivered', to_date('09-05-2024', 'dd-mm-yyyy'), 705165132);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (95100, 24, 'in-preparation', to_date('11-04-2024', 'dd-mm-yyyy'), 201884188);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (49245, 35, 'in-preparation', to_date('09-04-2024', 'dd-mm-yyyy'), 929328580);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (25789, 44, 'Received', to_date('01-01-2024', 'dd-mm-yyyy'), 507754009);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (13297, 159, 'Sent', to_date('12-03-2024', 'dd-mm-yyyy'), 320214197);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (95007, 24, 'Delivered', to_date('05-03-2024', 'dd-mm-yyyy'), 218429826);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (82691, 519, 'Ready', to_date('04-05-2024', 'dd-mm-yyyy'), 181724644);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (92346, 129, 'Received', to_date('11-04-2024', 'dd-mm-yyyy'), 449616736);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (24927, 78, 'in-preparation', to_date('10-02-2024', 'dd-mm-yyyy'), 709566924);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (97433, 149, 'Received', to_date('11-05-2024', 'dd-mm-yyyy'), 312294196);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (43069, 156, 'Received', to_date('25-04-2024', 'dd-mm-yyyy'), 979954238);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (96276, 25, 'Sent', to_date('26-05-2024', 'dd-mm-yyyy'), 898190326);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (65757, 125, 'in-preparation', to_date('05-02-2024', 'dd-mm-yyyy'), 296255366);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (91881, 399, 'Sent', to_date('09-02-2024', 'dd-mm-yyyy'), 909589275);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (66680, 22, 'Sent', to_date('26-03-2024', 'dd-mm-yyyy'), 898190326);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (54648, 138, 'in-preparation', to_date('24-03-2024', 'dd-mm-yyyy'), 193177293);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (59350, 10, 'in-preparation', to_date('02-02-2024', 'dd-mm-yyyy'), 603150426);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (30036, 39, 'Delivered', to_date('04-01-2024', 'dd-mm-yyyy'), 656442110);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (60302, 72, 'Received', to_date('16-03-2024', 'dd-mm-yyyy'), 449860234);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (28357, 99, 'Delivered', to_date('07-04-2024', 'dd-mm-yyyy'), 221770313);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (49352, 16, 'Ready', to_date('09-01-2024', 'dd-mm-yyyy'), 216541625);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (58785, 129, 'Sent', to_date('24-02-2024', 'dd-mm-yyyy'), 970287710);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (43714, 45, 'Ready', to_date('25-04-2024', 'dd-mm-yyyy'), 838802596);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (34742, 169, 'in-preparation', to_date('22-04-2024', 'dd-mm-yyyy'), 826107453);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (66809, 42, 'in-preparation', to_date('07-01-2024', 'dd-mm-yyyy'), 923324345);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (52809, 385, 'Sent', to_date('11-01-2024', 'dd-mm-yyyy'), 523316363);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (58643, 5, 'Ready', to_date('14-04-2024', 'dd-mm-yyyy'), 463371951);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (44583, 20, 'in-preparation', to_date('17-03-2024', 'dd-mm-yyyy'), 312294196);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (35836, 289, 'Sent', to_date('12-04-2024', 'dd-mm-yyyy'), 205272172);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (96721, 125, 'Delivered', to_date('06-05-2024', 'dd-mm-yyyy'), 221244365);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (91377, 24, 'Ready', to_date('29-03-2024', 'dd-mm-yyyy'), 185636514);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (70179, 99, 'in-preparation', to_date('18-04-2024', 'dd-mm-yyyy'), 805854680);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (15697, 89, 'Sent', to_date('23-05-2024', 'dd-mm-yyyy'), 273481859);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (57588, 15, 'Ready', to_date('23-02-2024', 'dd-mm-yyyy'), 369053838);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (83376, 43, 'in-preparation', to_date('24-02-2024', 'dd-mm-yyyy'), 656234359);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (74382, 118, 'Delivered', to_date('11-02-2024', 'dd-mm-yyyy'), 251021859);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (62055, 69, 'in-preparation', to_date('17-04-2024', 'dd-mm-yyyy'), 318322784);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (13231, 55, 'Sent', to_date('16-02-2024', 'dd-mm-yyyy'), 704448570);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (79722, 24, 'Received', to_date('13-03-2024', 'dd-mm-yyyy'), 886831669);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (53224, 10, 'in-preparation', to_date('13-01-2024', 'dd-mm-yyyy'), 181724644);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (28486, 265, 'in-preparation', to_date('06-01-2024', 'dd-mm-yyyy'), 799777319);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (91497, 45, 'Received', to_date('21-04-2024', 'dd-mm-yyyy'), 497469605);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (70816, 18, 'Delivered', to_date('11-04-2024', 'dd-mm-yyyy'), 732741572);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (98042, 35, 'Received', to_date('15-04-2024', 'dd-mm-yyyy'), 420529630);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (40275, 35, 'in-preparation', to_date('16-04-2024', 'dd-mm-yyyy'), 594264009);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (79488, 6, 'Received', to_date('03-01-2024', 'dd-mm-yyyy'), 738200510);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (45203, 235, 'Delivered', to_date('16-03-2024', 'dd-mm-yyyy'), 455396724);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (84999, 156, 'Received', to_date('24-02-2024', 'dd-mm-yyyy'), 152909198);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
...
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (42390, 259, 'Ready', to_date('11-01-2024', 'dd-mm-yyyy'), 336195988);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (28440, 209, 'in-preparation', to_date('04-02-2024', 'dd-mm-yyyy'), 272724345);
insert into ORDERS (orderid, orderprice, orderstatus, orderdate, custid)
values (14722, 25, 'Received', to_date('03-02-2024', 'dd-mm-yyyy'), 535781565);
commit;
prompt 400 records loaded
...
alter table PRODUCT enable constraint SYS_C008240;
prompt Enabling foreign key constraints for INGREDIENTS...
alter table INGREDIENTS enable constraint SYS_C008268;
alter table INGREDIENTS enable constraint SYS_C008269;
prompt Enabling foreign key constraints for ORDERS...
alter table ORDERS enable constraint SYS_C008252;
prompt Enabling foreign key constraints for MEALORDER...
alter table MEALORDER enable constraint SYS_C008262;
alter table MEALORDER enable constraint SYS_C008263;
prompt Enabling foreign key constraints for WORKERORDER...
alter table WORKERORDER enable constraint SYS_C008256;
alter table WORKERORDER enable constraint SYS_C008257;
